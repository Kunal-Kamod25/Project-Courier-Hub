...
export function AdminDashboard({ navigateTo, user, onLogout }) {
  ...
  return (
    <div className="min-h-screen text-white">
      {/* Header */}
      <div className="bg-white/10 backdrop-blur-md text-white shadow-lg border-b border-white/20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid md:grid-cols-4 gap-6 mb-8">
          <Card className="bg-white/20 backdrop-blur-md border border-white/30 text-white shadow-lg hover:scale-105 transition-transform">
        ...
        <div className="flex gap-4 mb-6">
          <Button
            ...
            className={activeTab === "bookings" ? "bg-white text-purple-900 hover:bg-white/90" : "bg-white/10 text-white border-white/30 hover:bg-white/20"}
          ...
          <Button
            ...
            className={activeTab === "users" ? "bg-white text-purple-900 hover:bg-white/90" : "bg-white/10 text-white border-white/30 hover:bg-white/20"}
