  ...
  return (
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8 text-white">
      <div className="max-w-2xl mx-auto">
        <Button variant="ghost" onClick={() => navigateTo("home")} className="mb-6 text-white hover:bg-white/20 hover:text-white">
        ...
        <Card className="shadow-xl">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-white text-2xl drop-shadow-md">Create Your Account</CardTitle>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="text-center text-sm text-white/80">
                ...
                <button type="button" onClick={() => navigateTo("login")} className="text-white font-semibold hover:underline">
                  Login here
                </button>
              </div>
            </form>
